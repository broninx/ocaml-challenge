...
# 203 "src/dot_parser.ml"
               : Dot_ast.file))
; (fun __caml_parser_env ->
    Obj.repr(
# 55 "src/dot_parser.mly"
                ( false )
# 209 "src/dot_parser.ml"
               : 'strict_opt))
; (fun __caml_parser_env ->
    Obj.repr(
# 56 "src/dot_parser.mly"
                ( true )
# 215 "src/dot_parser.ml"
               : 'strict_opt))
; (fun __caml_parser_env ->
    Obj.repr(
# 60 "src/dot_parser.mly"
          ( false )
# 221 "src/dot_parser.ml"
               : 'graph_or_digraph))
; (fun __caml_parser_env ->
    Obj.repr(
# 61 "src/dot_parser.mly"
          ( true )
# 227 "src/dot_parser.ml"
               : 'graph_or_digraph))
; (fun __caml_parser_env ->
    Obj.repr(
# 65 "src/dot_parser.mly"
                ( [] )
# 233 "src/dot_parser.ml"
               : 'stmt_list))
; (fun __caml_parser_env ->
...
# 71 "src/dot_parser.mly"
                                ( _1 :: _3 )
# 257 "src/dot_parser.ml"
               : 'list1_stmt))
; (fun __caml_parser_env ->
    Obj.repr(
# 75 "src/dot_parser.mly"
                ( () )
# 263 "src/dot_parser.ml"
               : 'semicolon_opt))
; (fun __caml_parser_env ->
    Obj.repr(
# 76 "src/dot_parser.mly"
                ( () )
# 269 "src/dot_parser.ml"
               : 'semicolon_opt))
; (fun __caml_parser_env ->
...
# 102 "src/dot_parser.mly"
                           ( _2 :: _3 )
# 351 "src/dot_parser.ml"
               : 'edge_rhs))
; (fun __caml_parser_env ->
    Obj.repr(
# 106 "src/dot_parser.mly"
                ( [] )
# 357 "src/dot_parser.ml"
               : 'edge_rhs_opt))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'node) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'edge_rhs_opt) in
...
# 116 "src/dot_parser.mly"
              ( _1, _2 )
# 387 "src/dot_parser.ml"
               : 'node_id))
; (fun __caml_parser_env ->
    Obj.repr(
# 120 "src/dot_parser.mly"
                ( None )
# 393 "src/dot_parser.ml"
               : 'port_opt))
; (fun __caml_parser_env ->
...
# 128 "src/dot_parser.mly"
	...
	in
	PortId (_2, Some cp) )
# 419 "src/dot_parser.ml"
               : 'port))
; (fun __caml_parser_env ->
    Obj.repr(
# 135 "src/dot_parser.mly"
                ( [] )
# 425 "src/dot_parser.ml"
               : 'attr_list_opt))
; (fun __caml_parser_env ->
...
# 141 "src/dot_parser.mly"
                           ( _2 :: _4 )
# 447 "src/dot_parser.ml"
               : 'attr_list))
; (fun __caml_parser_env ->
    Obj.repr(
# 145 "src/dot_parser.mly"
                ( None )
# 453 "src/dot_parser.ml"
               : 'id_opt))
; (fun __caml_parser_env ->
...
# 156 "src/dot_parser.mly"
              ( _1, Some _3 )
# 492 "src/dot_parser.ml"
               : 'equality))
; (fun __caml_parser_env ->
    Obj.repr(
# 160 "src/dot_parser.mly"
                ( () )
# 498 "src/dot_parser.ml"
               : 'comma_opt))
; (fun __caml_parser_env ->
    Obj.repr(
# 161 "src/dot_parser.mly"
                ( () )
# 504 "src/dot_parser.ml"
               : 'comma_opt))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : Dot_ast.id) in
    Obj.repr(
